...
const ScheduledResultAnalysis = () => {
  ...
  useEffect(() => {
    const fetchResultDetails = async () => {
      ...
      try {
        ...
        // It now calls the endpoint for SCHEDULED results.
        const response = await fetch(
          `http://localhost:5000/api/results/scheduled-results/${resultId}`,
          {
  ...
  // --- All the rendering logic below is identical to your original file ---
  const pieChartData = [
...
export default ScheduledResultAnalysis;
